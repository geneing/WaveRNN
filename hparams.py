...
wav_path = '/mnt/local/TrainingData/M-AILABS/mary_ann/wavs/'
data_path = 'data/'

# model ids are separate - that way you can use a new tts with an old wavernn and vice versa
# NB: expect undefined behaviour if models were trained on different DSP settings
voc_model_id = 'maryann_mol'
tts_model_id = 'maryannlldl_tts'
...
voc_target = 16_000                 # target number of samples to be generated in each batch entry
...
forward_checkpoint_every = 5_000        # checkpoints the model every X steps
